...
```{r}
#| label: elbow-method
#| fig-cap: "Figure 4. Elbow Method for Optimal K"
set.seed(123)
...
#| fig-cap: "Figure 5. Economic Risk Profiles Matrix"
#| fig-width: 9
#| fig-height: 7
ggplot(cpi_results, aes(x = avg_inf, y = volatility, color = cluster)) +
  ...
  labs(
    title = "Macroeconomic Risk Clustering",
    subtitle = "Grouping CPI Divisions by Stability and Price Trends",
